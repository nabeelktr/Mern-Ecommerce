...
const ChatBox = ({ chat, isAdmin }) => {
  ...
  return (
    <div className="rounded-lg bg-white md:p-2 p-1 cursor-pointer md:w-[25rem] " onClick={handleOrderId}>
      <div className="flex flex-row justify-between">
        <div className="flex flex-row space-x-2">
          <StyledBadge
            ...
            variant="dot"
          >
            <img src="https://www.shutterstock.com/image-vector/default-avatar-profile-icon-social-600nw-1677509740.jpg" className="md:h-14 h-12 md:w-14 w-12" />
          </StyledBadge>
          </div>
        ...
        <span sx={{ fontWeight: 400 }} className="text-[0.6rem] md:text-xs font-light">
            12:10
          </span>
