...
const Footer = () => {
  return (
    <footer className="px-3 pt-4 lg:px-9 border-t-2 bg-gray-50 font-poppins">
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="sm:col-span-2">
          <a href="#" className="inline-flex items-center">
            <span className="ml-2 text-xl font-semibold tracking-wide text-gray-800">Wyntra</span>
          </a>
          <div className="mt-6 lg:max-w-xl ">
            <p className="md:text-sm text-xs text-gray-800">
        ...
        <div className="flex flex-col gap-2 text-sm">
          <p className="md:text-base font-semibold tracking-wide text-gray-900">Popular Collections</p>
          <a href="#" >UPSC - Union Public Service Commission</a>
          <a href="#">General Knowledge</a>
          <a href="#">MBA</a>
          <p className="md:text-base font-semibold tracking-wide text-gray-900">New Arrivals</p>
        ...
        <div>
          ...
          <p className="md:text-base font-semibold tracking-wide text-gray-900">Contacts</p>
          <div className="flex">
            <p className="mr-1 text-gray-800 text-sm">Email:</p>
            <a href="#" title="send email" className='text-sm'>admin@wyntra.com</a>
          </div>
        </div>
      </div>

      <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
        <p className="md:text-sm text-xs text-gray-600">© Copyright 2023 Company. All rights reserved.</p>
        <ul className="flex flex-col mb-3 space-y-2 lg:mb-0 sm:space-y-0 sm:space-x-5 sm:flex-row">
          <li>
            <a href="#" className="md:text-sm text-xs text-gray-600 transition-colors duration-300 hover:text-deep-purple-accent-400">
