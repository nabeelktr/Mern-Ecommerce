      ...
      <div className=" flex">
        ...
        <div className="w-2/5"> 
            ...
            <span className="text-sm font-semibold pt-8 flex uppercase ">Select size</span>
                {
                  (!size && touched) && <span className="text-xs text-red-200">Please select a size</span>
                }
            <div className="pt-4">
              {
                qty > 0 ?
                  ...
                  <button 
                    ...
                    size === data.size ? 'border-pink-500 text-pink-500' : 'border-gray-500'
                    }`}
                ...
                :
                <span className="font-bold text-lg py-4 px-5 mr-3 mt-3 text-red-400">Out of Stock</span>
            }
            </div>
